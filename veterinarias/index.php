...
<html lang="es">
    <head>
        ...
        <link href="/veter/assets/css/input.css" rel="stylesheet">
        ...
        <main class="p-20 h-screen">
          ...
          <div class="w-full max-w-sm bg-a_brass rounded-lg border border-gray-200 shadow-md">
              <div class="flex flex-col items-center py-10">
                  ...
                  <a href="/veter/sites/Emer" class="btn btn-link btn-just-icon btn-neutral text-buff"><h5 class="mb-1 text-xl font-medium text-buff">EmerPet</h5></a>
